...
$permissionaccesslink = has_capability('moodle/role:switchroles', $context);
...
$PAGE->set_url('/course/managementteacher.php', $searchcriteria + $urlparams);
...
$strsearch = new lang_string("manageteacherelo");
...
$PAGE->navbar->add($strsearch, new moodle_url('/course/managementteacher.php?all=#'));
if (!empty($search)) {
...
if (empty($searchcriteria)) {
    ...
    //$PAGE->set_button($searchform); //origin
...
$site->fullname = get_string('manageteacherelo');
$PAGE->set_heading($site->fullname);

echo $OUTPUT->header();
echo $courserenderer->show_giangvien($searchcriteria);
echo $OUTPUT->footer();
