...
/**
 * English language file for eloflexsections format
 *
...
$string['page-course-view-eloflexsections'] = 'Any course main page in eloflexsections format';
$string['page-course-view-eloflexsections-x'] = 'Any course page in eloflexsections format';
$string['pluginname'] = 'ELO advanced flexible sections format';
