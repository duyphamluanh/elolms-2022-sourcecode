...
$PAGE->set_url('/course/managementstudent.php', $searchcriteria + $urlparams);
...
$strsearch = new lang_string("managestudentelo");
...
$PAGE->navbar->add($strsearch, new moodle_url('/course/managementstudent.php?all=#'));
if (!empty($search)) {
...
$site->fullname=get_string('managestudentelo');
$PAGE->set_heading($site->fullname);

echo $OUTPUT->header();
echo $courserenderer->show_hocvien($searchcriteria);
echo $OUTPUT->footer();
