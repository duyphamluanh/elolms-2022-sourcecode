@report @report_eloprogress
Feature: Teacher can view and override users' activity completion data via the eloprogress report.
  In order to view and override a student's activity completion status
  As a teacher
  I need to view the course eloprogress report and click the respective completion status icon
