 ...
 *
 * @module     report_eloprogress/completion_override
...
define(['jquery', 'core/ajax', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/notification',
    ...
    function($, Ajax, Str, ModalFactory, ModalEvents, Notification, CustomEvents, Templates) {
        ...
        var setOverride = function(override) {
            ...
            Templates.render('core/loading', {}).then(function(html) {
                ...
                Str.get_string(tooltipKey, 'completion', userFullName).then(function(stateString) {
                    ...
                    return Str.get_string('eloprogress-title', 'report_eloprogress', params);
        ...
        var init = function(fullName) {
            ...
            $('#completion-eloprogress-dttable a.changecompl').each(function(index, element) {
            ...
            $('#completion-eloprogress-dttable').on(CustomEvents.events.activate, "a.changecompl", function(e, data) {
                userConfirm(e, data);
            });
        };

        return /** @alias module:report_eloprogress/completion_override */ {
            init: init
        };
    });
