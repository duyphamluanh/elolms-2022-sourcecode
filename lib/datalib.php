...
function get_courses_search($searchterms, $sort, $page, $recordsperpage, &$totalcount,
    ...
    if ($DB->get_dbfamily() == 'oracle') {
        ...
        //$concat = $DB->sql_concat("COALESCE(c.summary, '')", "' '", 'c.fullname', "' '", 'c.idnumber', "' '", 'c.shortname');//origin
        $concat = $DB->sql_concat("COALESCE(c.fullname, '')", "' '", 'c.shortname');// 21_01_2019 nhien elo fix search
    }
