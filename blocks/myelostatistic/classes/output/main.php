...
// Nhien Course View Mark $percentage = progress::get_course_progress_percentage($course);
        ...
        $nocoursesurl = $output->image_url('courses', 'block_myelostatistic')->out();
        $noeventsurl = $output->image_url('activities', 'block_myelostatistic')->out();

        // Now, set the tab we are going to be viewing.
        $viewingtimeline = false;
        $viewingcourses = false;
        if ($this->tab == BLOCK_MYELOSTATISTIC_TIMELINE_VIEW) {
