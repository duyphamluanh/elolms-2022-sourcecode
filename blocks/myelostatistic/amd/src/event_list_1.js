 ...
 * given day range.
 *
 * @module     block_myelostatistic/event_list
...
define(['jquery', 'core/notification', 'core/templates',
        ...
        'block_myelostatistic/calendar_events_repository'],
    ...
    var TEMPLATES = {
        EVENT_LIST_ITEMS: 'block_myelostatistic/event-list-items',
        COURSE_EVENT_LIST_ITEMS: 'block_myelostatistic/course-event-list-items'
    };
