...
$string['defaulttab_desc'] = 'The tab that will be displayed when a user first views their Course eloworks. When returning to their Course eloworks, the user\'s active tab is remembered.';
$string['future'] = 'Future';
$string['inprogress'] = 'In progress';
$string['morecourses'] = 'More courses';
$string['myeloworks:addinstance'] = 'Add a new Course eloworks block';
$string['myeloworks:myaddinstance'] = 'Add a new Course eloworks block to Dashboard';
...
$string['past'] = 'Past';
$string['pluginname'] = 'Các công việc cần làm';
...
$string['markeloworks:elowworks'] = 'Chấm điểm';