 ...
 * given day range.
 *
 * @module     block_myeloworks/event_list
...
define(['jquery', 'core/notification', 'core/templates',
        ...
        'block_myeloworks/calendar_events_repository'],
    ...
    var TEMPLATES = {
        EVENT_LIST_ITEMS: 'block_myeloworks/event-list-items',
        COURSE_EVENT_LIST_ITEMS: 'block_myeloworks/course-event-list-items'
    };
