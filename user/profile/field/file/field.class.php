    ...
    public function display_data() {
        ...
        foreach ($files as $file) {
            $path = '/' . $context->id . '/profilefield_file/files_' . $this->fieldid . '/' .
                    ...
                    $file->get_filepath() .
                    $file->get_filename();
            if($this->field->name == 'Hình Cover'){// Nhien Cover
            $url = file_encode_url("$CFG->wwwroot/pluginfile.php", $path,false);
            $filename = $file->get_filename();
            $data[] = html_writer::img($url, $filename,array('width' => '100%'));
            //$data[] = '<img src= "' . $url . '" alt="' . $filename . '" width=100%>';
            //<img src="img_girl.jpg" alt="Girl in a jacket" width="100">
