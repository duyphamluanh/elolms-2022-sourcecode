...
$PAGE->requires->js('/theme/ouelofordson/javascript/scrollspy.js');
$PAGE->requires->js('/theme/ouelofordson/javascript/tooltipfix.js');
$PAGE->requires->js('/theme/ouelofordson/javascript/blockslider.js');

$templatecontext['flatnavigation'] = $PAGE->flatnav;
echo $OUTPUT->render_from_template('theme_ouelofordson/columns2', $templatecontext);