...
namespace theme_ouelofordson\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function headerbkglocation() {
        $theme = theme_config::load('ouelofordson');
    ...
    public function full_header() {
        ...
        //Nhien elo card header
        $header->elocard = $this->elo_get_pagetype();

        return $this->render_from_template('theme_ouelofordson/header', $header);
    }
    ...
    public function headerimage() {
        ...
        /*if (isset($COURSE->image)) { //$COURSE->image
                $eloopenfile=fopen($COURSE->image,"r");
                if ($eloopenfile){
                    $courseimage = $COURSE->image;
                }    
        }*/
        if (isset($COURSE->banner)) { //$COURSE->image
                $eloopenfile=fopen($COURSE->banner,"r");
                if ($eloopenfile){
...
//                $courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/covermonhoc.png';
                //$courseimageid  = $COURSE->id % 10;
                //$courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/courseimages/courseimage'. $courseimageid . '.jpg';
...
// Tui may dua nao ko co thi lay trong file pix
        if(!$headerbg){
            $headerbg = $CFG->wwwroot. '/theme/ouelofordson/pix/headerbg.png';
        }
        if(!$headerbgimgurl){
            $headerbgimgurl = $CFG->wwwroot. '/theme/ouelofordson/pix/headerbgimg.jpg';
        }
        if(!$usercoverimagepath ){
            $usercoverimagepath = $CFG->wwwroot. '/theme/ouelofordson/pix/usercoverimage.png';
        }
        if (isloggedin() and isguestuser())
        {
            //isset($COURSE->image) ? $courseimage= $COURSE->image
              //      : $courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/covermonhoc.png';;
            $courseimageid  = $COURSE->id % 10;
            $courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/courseimages/courseimage'. $courseimageid . '.jpg';          
        }                       
       // if(!$courseimage){
        //    $courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/courseimage.png';
       // }        
...
// End Nhien 
        ...
        if (theme_ouelofordson_get_setting('showcourseheaderimage') && $courseimage) {
        ...
        } else if (theme_ouelofordson_get_setting('showcourseheaderimage') && !$courseimage && isset($headerbg)) {
        ...
        } else if ($courseimage && isset($headerbg) && !theme_ouelofordson_get_setting('showcourseheaderimage')) {
            $html .= html_writer::start_div('customimage', array(
                'style' => 'background-image: url("' . $headerbgimgurl . '"); background-size: cover; background-position:center;
                width: 100%; height: 100%;'
            ));
    ...
    public function edit_button_fhs() {
        ...
        if  ($PAGE->pagelayout == 'course') {
            ...
            if ($PAGE->user_is_editing()) {
                ...
                $title = get_string('editoff', 'theme_ouelofordson');
                $icon = 'fa-power-off';
            }
            else {
                $url->param('edit', 'on');
                $btn = 'btn-success editingbutton';
                $title = get_string('editon', 'theme_ouelofordson');
                $icon = 'fa-edit';
            }
    ...
    */
    public function ouelofordson_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismymodules', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemymodules', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismyunits', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemyunits', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismyclasses', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemyclasses', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'training') {
                $branchtitle = get_string('mytraining', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismytraining', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemytraining', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'pd') {
                $branchtitle = get_string('myprofessionaldevelopment', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismyprofessionaldevelopment', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemyprofessionaldevelopment', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'cred') {
                $branchtitle = get_string('mycred', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismycred', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemycred', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'plan') {
                $branchtitle = get_string('myplans', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismyplans', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemyplans', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'comp') {
                $branchtitle = get_string('mycomp', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismycomp', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemycomp', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'program') {
                $branchtitle = get_string('myprograms', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismyprograms', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemyprograms', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'lecture') {
                $branchtitle = get_string('mylectures', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismylectures', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemylectures', 'theme_ouelofordson');
            } else if ($mycoursetitle == 'lesson') {
                $branchtitle = get_string('mylessons', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismylessons', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemylessons', 'theme_ouelofordson');
            } else {
                $branchtitle = get_string('mycourses', 'theme_ouelofordson');
                $thisbranchtitle = get_string('thismycourses', 'theme_ouelofordson');
                $homebranchtitle = get_string('homemycourses', 'theme_ouelofordson');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_ouelofordson');
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template('theme_ouelofordson/activitygroups', $context);
        }
    ...
    public function courseactivities_menu() {
        ...
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_ouelofordson');
            $branchlabel = $branchtitle;
            $branchurl = new moodle_url('#');
            $branch = $menu->add($branchlabel, $branchurl, $branchtitle, 10002);

            $data = theme_ouelofordson_get_course_activities();
    ...
    public function social_icons() {
        ...
        return $this->render_from_template('theme_ouelofordson/socialicons', $socialcontext);
    ...
    public function fp_wonderbox() {
        ...
        return $this->render_from_template('theme_ouelofordson/fpwonderbox', $fp_wonderboxcontext);
    ...
    public function customlogin() {
        ...
        return $this->render_from_template('theme_ouelofordson/customlogin', $customlogin_context);
    ...
    public function fp_marketingtiles() {
        ...
        return $this->render_from_template('theme_ouelofordson/fpmarkettiles', $fp_marketingtiles);
    }
    ...
    public function fp_slideshow() {
        ...
        return $this->render_from_template('theme_ouelofordson/slideshow', $fp_slideshow);
    }
    ...
    public function teacherdashmenu() {
        ...
        if (isloggedin() && ISSET($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_ouelofordson');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_ouelofordson');
            }
        }
        ...
        $siteadmintitle = get_string('siteadminquicklink', 'theme_ouelofordson');
        ...
        return $this->render_from_template('theme_ouelofordson/teacherdashmenu', $dashmenu);
    }
    ...
    public function teacherdash() {
        ...
        // Link catagories.
        $haspermission = has_capability('enrol/category:config', $context) && $PAGE->theme->settings->coursemanagementtoggle && isset($COURSE->id) && $COURSE->id > 1;
        $userlinks = get_string('userlinks', 'theme_ouelofordson');
        $userlinksdesc = get_string('userlinks_desc', 'theme_ouelofordson');
        $qbank = get_string('qbank', 'theme_ouelofordson');
        $qbankdesc = get_string('qbank_desc', 'theme_ouelofordson');
        $badges = get_string('badges', 'theme_ouelofordson');
        $badgesdesc = get_string('badges_desc', 'theme_ouelofordson');
        $coursemanage = get_string('coursemanage', 'theme_ouelofordson');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_ouelofordson');
        $coursemanagementmessage = (empty($PAGE->theme->settings->coursemanagementtextbox)) ? false : format_text($PAGE->theme->settings->coursemanagementtextbox);
        ...
        $eloactivitycompletiontitle = get_string('eloactivitycompletion', 'report_eloprogress');
        $eloactivitycompletionlink = new moodle_url('/report/eloprogress/index.php', array(
            'course' => $PAGE->course->id
        ));// Nhien        
        ...
        if (\core_completion\progress::get_course_progress_percentage($PAGE->course)) {
            ...
            //$comppercent = number_format($comppc, 0);//origin
            $comppercent = floor($comppc);// update 10_05_2019
            $hasprogress = true;
        } else {
            $comppercent = 0;
            $hasprogress = false;
        ...
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_ouelofordson') ,
            'icon' => 'map'
        );
        $summary = theme_ouelofordson_strip_html_tags($COURSE->summary);
        $summarytrim = theme_ouelofordson_course_trim_char($summary, 300);
        $courseinfo = array(
            array(
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_ouelofordson') ,
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_ouelofordson');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_ouelofordson');
        $mygradestext = get_string('mygradestext', 'theme_ouelofordson');
        $myprogresstext = get_string('myprogresstext', 'theme_ouelofordson');
        ...
        'dashlinks' => array(
            ...
            array(
                'hasuserlinks' => $eloactivitycompletiontitle,
                'title' => $eloactivitycompletiontitle,
                'url' => $eloactivitycompletionlink
            ) ,// Nhien
            array(
        ...
        return $this->render_from_template('theme_ouelofordson/teacherdash', $dashlinks);
    ...
    public function render_login(\core_auth\output\login $form) {
        global $SITE, $PAGE, $OUTPUT; //toan 13072021
        ...
        $url = $this->get_logo_url($context->elocarddefaultlogin);

        // Custom logins.
	$context->linkhuongdandangkythi = $OUTPUT->pix_icon('i/huongdanthi', 'Hướng dẫn thi HỌC KỲ 202-NH2020-2021','',array('style'=>'width:64px;height:74px;'));//toan 13072021
    ...
    public function favicon() {
        // Nhien favicon
        global $CFG;
        $elofavion = $this->page->theme->setting_file_url('favicon', 'favicon');
        if(!$elofavion){
            $elofavion = $CFG->wwwroot. '/theme/ouelofordson/pix/favicon.ico';
        }
        return $elofavion;
    }
    ...
    public function get_compact_logo_url($maxwidth = 100, $maxheight = 100) {
        ...
        if(!$elo_compact_logo){
        $elo_compact_logo = $CFG->wwwroot. '/theme/ouelofordson/pix/navlogo.png';}
        return $elo_compact_logo;
    }
    
    public function get_logo_url($idelopage,$maxwidth = null, $maxheight = 200) {
        // Nhien
        global $CFG;
        $eloresult =  parent::get_logo_url($maxwidth, $maxheight);
        if($eloresult){
            return $eloresult;
        }
        $idelopage == 'site-index' ? $elo_login_logo = $CFG->wwwroot. '/theme/ouelofordson/pix/headerlogo.png' :
        $elo_login_logo = $CFG->wwwroot. '/theme/ouelofordson/pix/logoblue.png';//Nhien elo 
    ...
    public function home_link() {
        ...
        if ($this->page->pagetype == 'site-index') {
            ...
            return '<div class="sitelink">' .
                   '<a title="eLearning-Trung tâm đào tạo trực tuyến " href="http://elo.edu.vn">' .
                   '<img src="' . $this->image_url('logo-dhmo') . '" alt="'.get_string('moodlelogo').'" /></a></div>';

        }*/
        return parent::home_link();
    }
...
/*    public function heading($text, $level = 2, $classes = null, $id = null) {
        if(!$classes)
        {
            ...
            $elopagetypeclass = $this->page->__get('pagetype');
            return html_writer::tag('h' . $level, $text, array('id' => $id, 'class' => $elopagetypeclass));
        }
        else{ //Tra ve nguyen ban
