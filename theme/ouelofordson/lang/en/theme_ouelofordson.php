...
// Theme strings.
$string['choosereadme'] = 'Ouelofordson provides a unique visual experience to the default Boost theme with customization features such as color choosers and enhanced homepage experience.';
$string['configtitle'] = 'Ouelofordson';
$string['pluginname'] = 'Ouelofordson';
...
$string['courseblockpanelbtn'] = 'Customized Course Block Panel';
...
$string['privacy:metadata'] = 'The Ouelofordson theme does not store any individual user data.';
...
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme. <a href="https://goo.gl/fMXzSo" target="_new">Instructions for Ouelofordson 3.5 Theme</a>';
$string['favicon'] = 'Favicon';
$string['favicon_desc'] = 'Change the favicon for Ouelofordson. Images with a transparent background and 32px height will work best.  Allowed types: PNG, JPG, ICO';
...
$string['generalcontentinfodesc'] = 'The options below help you customize the way content is displayed and turn on additional features for Ouelofordson.';
...
$string['pagelayout_desc'] = 'Choose from the following layouts.  <a href="https://goo.gl/fMXzSo" target="_new">Instructions for Ouelofordson 3.5 Theme</a>';
...
$string['pagelayout5'] = 'ELO Boost Layout / Header Image in Course Title Box';

$string['sectionlayout'] = 'Section Style Chooser';
$string['sectionlayout_desc'] = 'Choose from the following topic/weekly section styles.  <a href="https://goo.gl/fMXzSo" target="_new">Instructions for Ouelofordson 3.5 Theme</a>';
$string['sectionlayout1'] = 'Boost Default';
$string['sectionlayout2'] = 'ELO section layout';
...
$string['blockwidthouelofordson'] = 'Block Column Width';
$string['blockwidthouelofordson_desc'] = 'Adjust the width of the block column.';
$string['fpsignup'] = 'Log in';
...
$string['coursetilestyle_desc'] = 'When viewing course categories you can choose from the following styles to display courses. <a href="https://goo.gl/fMXzSo" target="_new">Instructions for Ouelofordson 3.5 Theme</a>';
...
$string['setting_navdrawersettings_desc'] = 'Enable the Boost nav drawer feature.  Ouelofordson does not require the nav drawer for navigation.  We have replaced it with a Jump-to-section dropdown. You may re-enable the nav drawer below.';
$string['shownavdrawer'] = 'Show Navdrawer';
$string['shownavdrawer_desc'] = 'Ouelofordson has eliminated the need for the nav drawer by utilizing a drop-down menu for in-course navigation.  If you must use the nav drawer you can check this box to re-enable it.';
...
* Ouelofordson > Custom Image Settings > Default Login Image can be used to change the background image for the login page. <br>
* Ouelofordson > Content Areas > Homepage Alert can be used to provide a notice on the top of the page. </b>';
...
$string['address:footer'] = 'Room 505, 97 Vo Van Tan Street, Vo Thi Sau Ward, District 3, Ho Chi Minh City';
