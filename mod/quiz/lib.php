...
function quiz_grade_item_update($quiz, $grades = null) {
    ...
    //---------------------------------NHien-------Loi cap nhat diem se hien thi sai setting quiz-----------------------------
    if ($quiz->grade > 0) {
        //$params['gradetype'] = GRADE_TYPE_VALUE;// eloMark
        $params['grademax']  = $quiz->grade;
        $params['grademin']  = 0;

    } else {
        //$params['gradetype'] = GRADE_TYPE_NONE; // eloMark
    }
