 ...
 */
class blockselo_import_data_import_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'general', get_string('pluginnamenotifi', 'block_elo_import_data'));
        // Data upload from copy/paste.
        $mform->addElement('textarea', 'userdata', 'Data', array('cols' => 130, 'rows' => 20, 'class' => 'userimport_data_area_elo'));
        ...
        $options = array('20' => 20, '100' => 100, '150' => 150, '1000' => 1000, '100000' => 100000);
        ...
        $mform->setDefault('forceimport', true);
        $this->add_action_buttons(false, get_string('btneloreports', 'block_elo_import_data'));
    }
