 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_elo_reminder_users_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('block_elo_reminder_users');
    ...
    public function test_fetcher_course1_group_members() {
        ...
        $now = time();
        $timetoshowusers = $CFG->block_elo_reminder_users_timetosee * 60;
        ...
        $this->assertEquals(3, $usercount, 'There was a problem counting the number of elo reminder users in group 1');
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users in group 1');
        ...
        $usercount = $onlineusers->count_users();
        $users = $onlineusers->get_users();
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users in group 2');
        $this->assertEquals(4, $usercount, 'There was a problem counting the number of elo reminder users in group 2');
        ...
        $usercount = $onlineusers->count_users();
        $users = $onlineusers->get_users();
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users in group 3');
        $this->assertEquals(0, $usercount, 'There was a problem counting the number of elo reminder users in group 3');
    }
    ...
    public function test_fetcher_courses() {
        ...
        $usercount = $onlineusers->count_users();
        $users = $onlineusers->get_users();
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users in course 1');
        $this->assertEquals(9, $usercount, 'There was a problem counting the number of elo reminder users in course 1');
        ...
        $usercount = $onlineusers->count_users();
        $users = $onlineusers->get_users();
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users in course 2');
        $this->assertEquals(0, $usercount, 'There was a problem counting the number of elo reminder users in course 2');
    }
    ...
    public function test_fetcher_sitelevel() {
        ...
        $usercount = $onlineusers->count_users();
        $users = $onlineusers->get_users();
        $this->assertEquals($usercount, count($users), 'There was a problem counting the number of elo reminder users at site level');
        $this->assertEquals(12, $usercount, 'There was a problem counting the number of elo reminder users at site level');
    }
    ...
    public function test_user_visibility_course1_group1_members() {
        ...
        $users = $onlineusers->get_users();
        $usercount = $onlineusers->count_users();
        // User1 should be displayed in the elo reminder users block.
        ...
        set_user_preference('block_elo_reminder_users_uservisibility', 0);
        ...
        $users = $onlineusers->get_users();
        $usercount = $onlineusers->count_users();
        // User1 should not be displayed in the elo reminder users block.
