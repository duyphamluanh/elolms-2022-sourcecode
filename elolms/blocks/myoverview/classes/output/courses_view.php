    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach ($this->courses as $course) {
            ...
            if (!isset($exportedcourse->courseimage)){
                ...
                if ($eloopenfile) {
                    $exportedcourse->courseimage = $imageurl30;
                    $exportedcourse->classes = 'courseimage';                    
                }   
            }
            ...
            if (!isset($exportedcourse->courseimage)) {
                ...
                $exportedcourse->courseimage = $pattern->datauri();origin*/
                $courseimageid  = $course->id % 10;
                $exportedcourse->courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/courseimages/courseimage'. $courseimageid . '.jpg';
                //isset($course->image) ? $exportedcourse->courseimage = $course->image : 
                  //      $exportedcourse->courseimage = $CFG->wwwroot. '/theme/ouelofordson/pix/courseimages/covercousedemo.jpg';         
