...
$string['continueloginviagmail'] = 'Login to school email';
...
$string['clickhereelo'] = 'click here.';
$string['dangnhaplogin'] = 'LOG IN';
$string['dangnhapguest'] = 'LOG IN GUEST';
//$string['elonotification'] = '- Currently, the system stops being used to import accounts from Gmail.<br>
//- Only allow login by system account.<br>
//- Please login by entering your email and password.<br>
//- In case you do not have a password or forgot password, please click link below to get a new password.</br>';
...
// manage teacher ELO , manage student ELO
$string['manageteacherelo'] = 'Manage teachers ELO';
$string['managestudentelo'] = 'Manage students ELO';
