...
$THEME->scss = function($theme) {
    return theme_ouelofordson_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_ouelofordson_css_tree_post_processor';
$THEME->prescsscallback = 'theme_ouelofordson_get_pre_scss';
$THEME->extrascsscallback = 'theme_ouelofordson_get_extra_scss';
