...
function theme_ouelofordson_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
 ...
 * @return string
 */
function theme_ouelofordson_get_setting($setting, $format = false) {
    global $CFG;
